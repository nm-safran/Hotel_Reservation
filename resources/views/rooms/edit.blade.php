            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="mb-0">Edit Room: {{ $room->room_number }}</h3>
                    </div>
                        ...
                        <form method="POST" action="{{ route('rooms.update', $room) }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select @error('room_type') is-invalid @enderror" id="room_type"
                                        ...
                                        <option value="standard"
                                            {{ old('room_type', $room->room_type) == 'standard' ? 'selected' : '' }}>
                                            Standard</option>
                                        <option value="deluxe"
                                            {{ old('room_type', $room->room_type) == 'deluxe' ? 'selected' : '' }}>Deluxe
                                        </option>
                                        <option value="suite"
                                            {{ old('room_type', $room->room_type) == 'suite' ? 'selected' : '' }}>Suite
                                        </option>
                                        <option value="residential_suite"
                                            {{ old('room_type', $room->room_type) == 'residential_suite' ? 'selected' : '' }}>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control @error('weekly_rate') is-invalid @enderror"
                                        ...
                                        value="{{ old('weekly_rate', $room->weekly_rate) }}" min="0" step="0.01">
                                    @error('weekly_rate')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control @error('monthly_rate') is-invalid @enderror"
                                        ...
                                        value="{{ old('monthly_rate', $room->monthly_rate) }}" min="0"
                                        step="0.01">
                                    @error('monthly_rate')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-8">
                                    ...
                                    <textarea class="form-control @error('amenities') is-invalid @enderror" id="amenities" name="amenities" rows="3">{{ old('amenities', $room->amenities) }}</textarea>
                                    @error('amenities')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
