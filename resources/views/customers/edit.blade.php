            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="mb-0">Edit Customer: {{ $customer->first_name }} {{ $customer->last_name }}</h3>
                    </div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('customers.update', $customer) }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select @error('id_type') is-invalid @enderror" id="id_type"
                                        ...
                                        <option value="passport"
                                            {{ old('id_type', $customer->id_type) == 'passport' ? 'selected' : '' }}>
                                            Passport</option>
                                        <option value="driver_license"
                                            {{ old('id_type', $customer->id_type) == 'driver_license' ? 'selected' : '' }}>
                                            Driver's License</option>
                                        <option value="national_id"
                                            {{ old('id_type', $customer->id_type) == 'national_id' ? 'selected' : '' }}>
                                            National ID</option>
                                        <option value="other"
                                            {{ old('id_type', $customer->id_type) == 'other' ? 'selected' : '' }}>Other
                                        </option>
                                    </select>
                                    @error('id_type')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-md-4">
                                    <div class="form-check mt-4 pt-2">
                                        <input class="form-check-input" type="checkbox" name="is_company" id="is_company"
                                            value="1" {{ old('is_company', $customer->is_company) ? 'checked' : '' }}>
                            ...
                            <div class="row mb-3 company-fields"
                                style="display: {{ $customer->is_company ? 'block' : 'none' }};">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('discount_rate', $customer->discount_rate) }}" min="0"
                                        max="100" step="0.01">
                                    @error('discount_rate')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
